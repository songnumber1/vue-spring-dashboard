...
public class MultipartFileService {
    ...
    public MultipartFileService() {
    }

    public static MultipartFileService fromPath(Path path) {
        return new MultipartFileService().setFilepath(path);
    }

    public static MultipartFileService fromFile(File file) {
        return new MultipartFileService().setFilepath(file.toPath());
    }

    public static MultipartFileService fromURIString(String uri) {
        return new MultipartFileService().setFilepath(Paths.get(uri));
    }

    // ** internal setter **//
    private MultipartFileService setFilepath(Path filepath) {
        this.filepath = filepath;
        return this;
    }

    public MultipartFileService with(HttpServletRequest httpRequest) {
        request = httpRequest;
        return this;
    }

    public MultipartFileService with(HttpServletResponse httpResponse) {
